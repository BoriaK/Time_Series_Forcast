...
for i in range(nb_epoch):
    ...
    if (i + 1) % 10 == 0:
        ...
        if i + 1 == 10:
            ...
            # CheckPoint = os.path.join(checkpoint_filepath, 'cp_5x10_' + str(i + 1) + '_epochs_' + Device)
...
##########################################################
# line plot of RMSE values during training
plt.plot(eval_count, rmse_arr)
plt.xlabel('Evaluation Steps')
plt.ylabel('RMSE')
plt.grid()
plt.title('RMSE Results over Evaluation Steps')
plt.show()
