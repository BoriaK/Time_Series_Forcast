...
ds_train = tf.data.Dataset.from_tensor_slices(train_scaled)
# ds_train = ds_train.batch(batch_size=1)
ds_train = ds_train.prefetch(buffer_size=tf.data.AUTOTUNE)
# print(ds_train.as_numpy_iterator())

ds_eval = tf.data.Dataset.from_tensor_slices(test_scaled)
# ds_eval.batch(batch_size=1)
ds_eval = ds_eval.prefetch(buffer_size=tf.data.AUTOTUNE)
print(ds_eval.as_numpy_iterator())
...
# # print(ds_y.as_numpy_iterator())
# ds_train = tf.data.Dataset.zip(ds_X, ds_y)
# print(ds_train.as_numpy_iterator())
