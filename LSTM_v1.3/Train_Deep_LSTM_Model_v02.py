...
for i in range(Max_Epochs):
    ...
    if i == 0:
        ...
        CheckPoint = os.path.join(checkpoint_filepath, 'cp_5x10_1k_samples_Random_Data_w_10_' + str(i + 1) + '_epochs_Deep_LSTM_Model')
        Deep_LSTM_Model.save(CheckPoint)
        print('checkpoint ' + '5x10 ' + '1k_samples_Random_Data_w_10 ' + str(i + 1) + ' epochs Deep_LSTM_Model' + ' is saved')
        ...
        CheckPoint = os.path.join(checkpoint_filepath,
                                  'cp_5x10_1k_samples_Random_Data_w_10_' + str(i + 1) + '_epochs_Deep_LSTM_Model')
        Deep_LSTM_Model.save(CheckPoint)
        print(
            'checkpoint ' + '5x10 ' + '1k_samples_Random_Data_w_10 ' + str(i + 1) + ' epochs Deep_LSTM_Model' + ' is saved')
...
plt.grid()
plt.savefig('./Result_Plots/' + 'Deep_LSTM_Model_1k_samples_Random_Data_w_10_' + str(i + 1) + '_epochs.png', bbox_inches='tight')
plt.show()
