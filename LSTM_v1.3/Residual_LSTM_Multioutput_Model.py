...
from Models_v01 import residual_lstm_multi_out
...
Residual_LSTM_Multi_Out_Model = residual_lstm_multi_out(LSTM_Window.example[0].shape[2])

print('Input shape:', LSTM_Window.example[0].shape)
print('Output shape:', Residual_LSTM_Multi_Out_Model(LSTM_Window.example[0]).shape)

Max_Epochs = 20

History = compile_and_fit(Residual_LSTM_Multi_Out_Model, LSTM_Window, epochs=Max_Epochs)
IPython.display.clear_output()
val_performance = {'RNN LSTM': Residual_LSTM_Multi_Out_Model.evaluate(LSTM_Window.val)}
# performance = {}
...
Wide_LSTM_Window.plot(Residual_LSTM_Multi_Out_Model)
####################################################
