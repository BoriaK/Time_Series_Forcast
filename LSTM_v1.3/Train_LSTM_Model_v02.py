...
for i in range(Max_Epochs):
    ...
    if i == 0:
        ...
        CheckPoint = os.path.join(checkpoint_filepath, 'cp_1x10_1k_samples_Random_Data_' + str(i + 1) + '_epochs_LSTM_Model')
        LSTM_Model.save(CheckPoint)
        print('checkpoint ' + '1x10_' + '1k_samples_Random_Data_' + str(i + 1) + '_epochs_LSTM_Model' + ' is saved')
...
plt.grid()
plt.savefig('./Result_Plots/' + 'LSTM_Model_1k_samples_Random_Data_' + str(i + 1) + '_epochs.png', bbox_inches='tight')
plt.show()
