...
from Models_v01 import dense_multi_out
...
Dense_Multi_Out_Model = dense_multi_out(Single_Step_Window.example[0].shape[2])

Max_Epochs = 20

History = compile_and_fit(Dense_Multi_Out_Model, Single_Step_Window, Max_Epochs)

val_performance = {'Baseline': Dense_Multi_Out_Model.evaluate(Single_Step_Window.val)}
# performance = {}
...
Wide_Window.plot(Dense_Multi_Out_Model)
